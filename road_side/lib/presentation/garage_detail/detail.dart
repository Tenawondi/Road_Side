...
class Detail extends StatefulWidget {
  const Detail({Key? key, required this.garage}) : super(key: key);
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
              ...
              children: <Widget>[
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      "${widget.garage.ImageUrl}",//foods[1]['img']
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
            ...
            SizedBox(height: 10.0),
            Text(
              "${widget.garage.Name}",//foods[1]['name']
              style: TextStyle(
                fontSize: 20,
            ...
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  SizedBox(width: 10.0),
                  Text(
                    "${widget.garage.Rating} (${widget.garage.Reviews})",
                    style: TextStyle(
                      fontSize: 11.0,
                    ),
                  ),
